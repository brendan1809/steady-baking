<%@ Page Title="" Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="FAQPage.aspx.cs" Inherits="Steady_Baking.Assets.FAQPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:BulletedList ID="BulletedList5" runat="server" OnClick="BulletedList5_Click5">
        <asp:ListItem>How do I know if my baking powder and baking soda are still fresh?</asp:ListItem>
    </asp:BulletedList>
    <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged1" style="height: 22px; margin-bottom: 1px">
        <asp:ListItem Value="We are definitely recommend using unsalted butter in baked goods, because you can control the total amount of salt in the recipe. However, if you do not have unsalted butter and don’t want to make a trip to the store, simply use your salted butter, but omit the salt in the recipe.">Can I use regular salted butter instead of unsalted butter?</asp:ListItem>
    </asp:DropDownList>
